...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.behavior_session_not_found":               "行为会话不存在",
		...
		"error.user_disabled":                            "操作失败，请稍后重试",
		...
		"error.risk_ip_blacklisted":                      "操作失败，请稍后重试",
		"error.risk_email_blacklisted":                   "操作失败，请稍后重试",
	...
	LocaleTW: {
		...
		"error.behavior_session_not_found":               "行為會話不存在",
		...
		"error.user_disabled":                            "操作失敗，請稍後重試",
		...
		"error.risk_ip_blacklisted":                      "操作失敗，請稍後重試",
		"error.risk_email_blacklisted":                   "操作失敗，請稍後重試",
	...
	LocaleEN: {
		...
		"error.behavior_session_not_found":               "Behavior session not found",
		...
		"error.user_disabled":                            "Operation failed. Please try again later",
		...
		"error.risk_ip_blacklisted":                      "Operation failed. Please try again later",
		"error.risk_email_blacklisted":                   "Operation failed. Please try again later",
